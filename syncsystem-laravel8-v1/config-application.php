...
$gSystemConfig['configDirectoryFiles'] = env('CONFIG_DIRECTORY_FILES'); // 'app_files_public'
$gSystemConfig['configDirectoryFilesLayout'] = env('CONFIG_DIRECTORY_FILES_LAYOUT'); // 'app_files_layout';
$gSystemConfig['configDirectoryFonts'] = env('CONFIG_DIRECTORY_FONTS'); // 'app_fonts';
$gSystemConfig['configDirectoryResources'] = env('CONFIG_DIRECTORY_RESOURCES'); // 'app_resources';
$gSystemConfig['configDirectoryStyles'] = env('CONFIG_DIRECTORY_STYLES'); // 'app_styles';
$gSystemConfig['configDirectoryJS'] = env('CONFIG_DIRECTORY_JS'); // 'app_js';
$gSystemConfig['configDirectoryViews'] = env('CONFIG_DIRECTORY_VIEWS'); // 'app_views';
$gSystemConfig['configDirectoryBuildLaravel'] = env('CONFIG_DIRECTORY_BUILD_LARAVEL'); // 'app_views';
...
/**/
$gSystemConfig['configDirectoryFilesSD'] = env('CONFIG_DIRECTORY_FILES_SD'); // 'files' | '' - when using remote
$gSystemConfig['configDirectoryFilesLayoutSD'] = env('CONFIG_DIRECTORY_FILES_LAYOUT_SD'); // 'files-layout'
$gSystemConfig['configDirectoryFontsSD'] = env('CONFIG_DIRECTORY_FONTS_SD'); // 'fonts'
$gSystemConfig['configDirectoryStylesSD'] = env('CONFIG_DIRECTORY_STYLES_SD'); // 'css'
$gSystemConfig['configDirectoryJSSD'] = env('CONFIG_DIRECTORY_JS_SD'); // 'js'
